...
namespace DiscordCoreAPI {
	...
	public:
		...
		virtual void execute(DiscordCoreAPI::BaseFunctionArguments* args) {
			...
			DiscordCoreInternal::Permissions permissions[10] = { DiscordCoreInternal::Permissions::CREATE_INSTANT_INVITE, DiscordCoreInternal::Permissions::ADD_REACTIONS, DiscordCoreInternal::Permissions::VIEW_CHANNEL,
			...
			DiscordCoreInternal::Permissions::ATTACH_FILES, DiscordCoreInternal::Permissions::SPEAK };
